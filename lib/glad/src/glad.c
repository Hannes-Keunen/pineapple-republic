...
PFNGLFLUSHmapped_bufferRANGEPROC glad_glFlushmapped_bufferRange = NULL;
...
static void load_GL_VERSION_3_0(GLADloadproc load) {
	...
	glad_glFlushmapped_bufferRange = (PFNGLFLUSHmapped_bufferRANGEPROC)load("glFlushmapped_bufferRange");
